...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Admin Sekmesi - Paylaşımları Yönet</title>
  </head>
  <body>
...
<div class="content">
   ...
   <h2 class="page-title">Paylasımı Düzenle</h2>
   ...
   <div>
    ...
    <div><button type="submit" name="update-post" class="btn btn-big">Paylaş</button></div>
   </form>
